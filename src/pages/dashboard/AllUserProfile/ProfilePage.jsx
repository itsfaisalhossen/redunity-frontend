...
//   <div
//     className={`flex items-center gap-3 px-4 py-3 rounded-2xl dark:bg-gray-900/60 dark:border-slate-800 dark:text-white/90  border ${PILL_COLORS[accent]}`}
//   >
...
//   disabled: `${base} bg-slate-100 border-slate-100 text-slate-400 cursor-not-allowed dark:bg-gray-900/60 dark:border-slate-800`,
// };
...
//         {/* ── Hero banner ── */}
//         <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-rose-600 via-red-500 to-pink-600 shadow-md shadow-rose-200 dark:shadow-rose-700">
//           {/* decorative blobs */}
...
//           {/* card header */}
//           <div className="flex items-center gap-3 px-6 py-4 border-b border-slate-100 dark:border-slate-600">
...
//                     readOnly={!isEditable}
//                     className={`${isEditable ? cls.editable : cls.readonly} pr-10 dark:bg-gray-900/60 dark:border-slate-800`}
//                   />
//                   <Camera
//                     size={15}
...
//         {/* ── Account security ── */}
//         <div className="bg-white border dark:bg-gray-900/60 dark:border-slate-800 border-slate-100 rounded-3xl overflow-hidden shadow-sm">
//           <div className="flex items-center gap-3 px-6 py-4 border-b  border-slate-100 dark:border-slate-600">
...
const base =
  "px-4 py-3 rounded-xl border text-sm outline-none transition-all duration-200 w-full";
const cls = {
  editable: `${base} bg-white border-slate-200 text-slate-800 focus:border-rose-400 focus:ring-2 focus:ring-rose-100 dark:bg-gray-900/60 dark:border-slate-800 dark:text-white/90`,
  readonly: `${base} bg-slate-50 border-slate-100 text-slate-500 cursor-default`,
  disabled: `${base} bg-slate-100 border-slate-100 text-slate-400 cursor-not-allowed dark:bg-gray-900/60 dark:border-slate-800`,
};
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <Field label="Display name">
                <input
                  ...
                  readOnly={!isEditable}
                  className={`${isEditable ? cls.editable : cls.readonly} pr-10 dark:bg-gray-900/60 dark:border-slate-800`}
                  // className={`isEditable ? cls.editable : cls.readonly dark:bg-gray-900/60 bg-gray-200/60 dark:border-slate-800 py-3 px-2`}
                />
              </Field>
