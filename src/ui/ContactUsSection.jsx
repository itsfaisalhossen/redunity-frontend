    ...
    <div>
      <Container>
        <section className="py-24 bg-white  dark:bg-primary-dark">
          <div className="bg-gray-50 rounded-[40px] overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-3/5 p-10 md:p-16 dark:bg-primary-dark bg-white">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-red-700 text-white font-bold rounded-2xl hover:bg-red-700 shadow-lg shadow-red-100 transition-all active:scale-[0.98] flex items-center justify-center gap-2  dark:shadow-none"
                >
